...
- Animação de código flutuante

### 2. **Sobre**
- Descrição pessoal e profissional
- Estatísticas animadas (experiência, projetos, linguagens)
...
- **Animações**: Fade-in, skill bars, contadores
- **Hover Effects**: Cards e elementos interativos
...
### Projetos
Substitua os projetos de exemplo pelos seus próprios:
- Título e descrição
